...
do
  ...
  do
    for model_name in 'roberta-base' 'bert-base-cased' 'allenai/scibert_scivocab_uncased';
    do
      ...
      --output_dir ./result/$ft_task'_'$model_name'_adapter'_$add_adapter'_seed'$round \
      --save_strategy no \
